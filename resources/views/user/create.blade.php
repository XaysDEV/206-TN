        ...
        <div class="col-lg-12">
          <div class="card card-default">
            ...
            <div class="card-header">
              <h3 class="card-title"><h4 class="card-title">ເພີ່ມໃໝ່</h4></h3>
            </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" placeholder="ຊື່ ແລະ ນາມສະກຸນ">
                              </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="phone"  placeholder="ເບີໂທລະສັບ">
                            </div>
                          </div>
                        <div class="col-md-12">
                          <div class="form-group">
